...
VIDEO_FILE = "final_output/Final_Masterpiece.mp4"
...
def parse_metadata():
    ...
    description = ""
    tags = "story, cinematic, longvideo"
...
def upload_video():
    ...
    ai_disclaimer = "यह एक ओरिजिनल कहानी है जिसे हमारी टीम ने क्रिएटिव एडिटिंग, AI Voice और AI Visuals का इस्तेमाल करके बनाया है।\n\n"
    final_description = ai_disclaimer + description

    print(f"📌 UPLOADING YOUTUBE VIDEO: {title}")
    ...
    request_body = {
        "snippet": {
            ...
            "title": title[:100], # Standard video title limit
    ...
    try:
        ...
        print(f"✅ LONG VIDEO SUCCESSFULLY UPLOADING! Link: https://youtu.be/{response['id']}")
    except Exception as e:
